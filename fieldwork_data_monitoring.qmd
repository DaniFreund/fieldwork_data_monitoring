---
title: "Tracking Wolf-Beaver Stress Field Season 2023"
format: 
  html:
    theme: lux
...
roads <- st_read("/Users/danifreund/Desktop/Research/Beaver Hair/BeaverHair_R/roads/trails.reprojected/trails_reprojected.shx")
```
...
ggplotly(progress.1 %>% 
  ggplot(aes(x = a.snare.id, y=value, fill = name)) +
  geom_histogram(stat = "identity", position = "stack") + 
  labs(y = "Days", x = "Snare ID") +
  scale_fill_manual(values = c("darkred", "darkcyan"),
                    name = "Progress", labels = c("predicted.days.left" = "Predicted days left", "total.days.to.complete" = "Days already spent in field")) +
  theme_classic() + 
  coord_flip())
...
timeline_plot<-timeline_plot+geom_text(aes(y=text_position,label=milestone),size=2.5, fontface="bold")
